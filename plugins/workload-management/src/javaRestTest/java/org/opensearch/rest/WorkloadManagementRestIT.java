...
public class WorkloadManagementRestIT extends OpenSearchRestTestCase {
    ...
    public void testSearchSettings() throws Exception {
        ...
        assertTrue(responseBody.contains("\"batched_reduce_size\":\"256\""));
        assertTrue(responseBody.contains("\"max_concurrent_shard_requests\":\"10\""));
        ...
        assertTrue(responseBody2.contains("\"timeout\":\"30s\""));
